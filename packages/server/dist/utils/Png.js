...
exports.Png = exports.PngInvalidCharacterError = exports.PngMissingCharacterError = exports.PngFormatError = exports.PngDecodeError = void 0;
const crc_32_1 = __importDefault(require("crc-32"));
class PngDecodeError extends Error {
}
exports.PngDecodeError = PngDecodeError;
class PngFormatError extends Error {
}
exports.PngFormatError = PngFormatError;
class PngMissingCharacterError extends Error {
}
exports.PngMissingCharacterError = PngMissingCharacterError;
...
exports.PngInvalidCharacterError = PngInvalidCharacterError;
/**
 * From https://github.com/ZoltanAI/character-editor/blob/main/index.html#L786
 */
class Png {
    ...
    static #readChunk(data, idx) {
        ...
        if (crc !== crc_32_1.default.buf(chunkData, crc_32_1.default.str(chunkType)))
            throw new PngDecodeError('CRC for "' +
                chunkType +
    ...
    static #encodeChunks(chunks) {
        ...
        chunks.forEach((c) => {
            ...
            // Write CRC field
            this.#int32[0] = c.crc || crc_32_1.default.buf(c.data, crc_32_1.default.str(c.type));
            output[idx++] = this.#uint8[3];
            output[idx++] = this.#uint8[2];
            output[idx++] = this.#uint8[1];
            output[idx++] = this.#uint8[0];
    ...
    static Generate(arrayBuffer, text) {
        ...
        const data = Png.#encodeText("chara", btoa(new TextEncoder()
            .encode(text)
            .reduce((a, c) => a + String.fromCharCode(c), "")));
        chunks.splice(-1, 0, {
            type: "tEXt",
            data,
            crc: crc_32_1.default.buf(data, crc_32_1.default.str("tEXt")),
        });
